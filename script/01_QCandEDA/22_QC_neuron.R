...
load("working_data/summarizedExperiment/fc_2pass/se_neuron.RData")
...
plot(1:length(Z.C),
     Z.C,
     main="Outlier Plot of Neuron Data",
     xlab = "Samples",
     ylab="Connectivity Z Score", 
     #col=factor(se_neuron$Diagnosis)
     )
...
save(file="working_data/summarizedExperiment/fc_2pass/se_neuron_CPM_outlierRemoved.RData", se_neuron)
