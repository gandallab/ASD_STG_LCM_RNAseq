...
load("working_data/wgcna/blocks.v3/blocks.bicor.recut.RData")
...
modTrait=read.delim("working_data/wgcna/blocks.v3//modTrait.blocks.bicor.txt")
...
for(i in 2:ncol(MEs$eigengenes)) {
  ...
  #Gene ontology  
  go = read.delim(paste("working_data/wgcna/blocks.v3/go/go.M",moduleNumber,"_",moduleColor,".txt",sep = ""),header = T,sep = "\t")
