...
load("working_data/wgcna/oligo.v4/oligo.bicor.recut.RData")
load("working_data/wgcna/voom.forWGCNA.input.oligo.v4.RData")
softpower=12
...
modTrait=read.delim("working_data/wgcna/oligo.v4/modTrait.oligo.bicor.txt")
...
for(i in 2:ncol(MEs$eigengenes)) {
  ...
  cairo_pdf(file=paste0("working_data//figures/moduleAnnot.oligo/", moduleNumber, moduleColor, ".pdf"), width=20, height=16,family = "Arial")
  ...
  #Gene ontology  
  go = read.delim(paste("working_data/wgcna/oligo.v4/go//go.M",moduleNumber,"_",moduleColor,".txt",sep = ""),header = T,sep = "\t")
  ...
  #   ind=FALSE
  # }
  # graph2ppt(file="working_data/figures/module.annotation.oligo.v2.pptx",width=18,height=15,append=ind)
  dev.off()
}
